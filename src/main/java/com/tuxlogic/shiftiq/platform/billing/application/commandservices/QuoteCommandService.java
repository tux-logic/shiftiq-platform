...
public interface QuoteCommandService {
     ...
     */
    Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.UpdateQuoteDiscountCommand command);
     ...
     */
    Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.ApproveQuoteCommand command);
     ...
     */
    Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.CancelQuoteCommand command);
}
