package com.tuxlogic.shiftiq.platform.billing.application.internal.queryservices;
...
public class QuoteQueryServiceImpl implements QuoteQueryService {
     ...
     */
    @Override
    public java.util.List<Quote> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.queries.GetQuotesByBranchIdQuery query) {
