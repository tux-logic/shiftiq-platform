...
public class QuoteCommandServiceImpl implements QuoteCommandService {
    ...
    @Override
    public Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.UpdateQuoteDiscountCommand command) {
    ...
    @Override
    public Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.ApproveQuoteCommand command) {
        var quoteOpt = quoteRepository.findById(command.quoteId());
    ...
    @Override
    public Result<Quote, QuoteCommandFailure> handle(com.tuxlogic.shiftiq.platform.billing.domain.model.commands.CancelQuoteCommand command) {
        var quoteOpt = quoteRepository.findById(command.quoteId());
