...
import com.tuxlogic.shiftiq.platform.billing.interfaces.rest.resources.UpdateQuoteResource;
import com.tuxlogic.shiftiq.platform.billing.interfaces.rest.transform.CreateQuoteCommandFromResourceAssembler;
import com.tuxlogic.shiftiq.platform.billing.interfaces.rest.transform.UpdateQuoteCommandFromResourceAssembler;
import com.tuxlogic.shiftiq.platform.billing.interfaces.rest.transform.QuoteResourceFromAggregateAssembler;
...
import com.tuxlogic.shiftiq.platform.billing.domain.model.commands.ApproveQuoteCommand;
import com.tuxlogic.shiftiq.platform.billing.domain.model.commands.CancelQuoteCommand;
import com.tuxlogic.shiftiq.platform.billing.domain.model.queries.GetQuotesByBranchIdQuery;
    ...
    private ResponseEntity<?> toErrorResponse(QuoteCommandFailure failure) {
        return switch (failure) {
            case WORK_ORDER_NOT_FOUND -> {
                ...
                yield com.tuxlogic.shiftiq.platform.shared.interfaces.rest.transform.ErrorResponseAssembler.toErrorResponseFromApplicationError(com.tuxlogic.shiftiq.platform.shared.application.result.ApplicationError.notFound("quote", message));
            }
            case INVALID_QUOTE_DATA -> {
                ...
                yield com.tuxlogic.shiftiq.platform.shared.interfaces.rest.transform.ErrorResponseAssembler.toErrorResponseFromApplicationError(com.tuxlogic.shiftiq.platform.shared.application.result.ApplicationError.validationError("quote", message));
            }
            case QUOTE_ALREADY_EXISTS_FOR_WORK_ORDER -> {
                ...
                yield com.tuxlogic.shiftiq.platform.shared.interfaces.rest.transform.ErrorResponseAssembler.toErrorResponseFromApplicationError(com.tuxlogic.shiftiq.platform.shared.application.result.ApplicationError.conflict("quote", message));
            }
