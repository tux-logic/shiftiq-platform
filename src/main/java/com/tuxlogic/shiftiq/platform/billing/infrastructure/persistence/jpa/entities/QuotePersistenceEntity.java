...
public class QuotePersistenceEntity extends AuditableAbstractPersistenceEntity {
    ...
    private com.tuxlogic.shiftiq.platform.shared.domain.model.valueobjects.BranchId branchId;

    @Column(name = "subtotal_amount", nullable = false)
    @Convert(converter = com.tuxlogic.shiftiq.platform.shared.infrastructure.persistence.jpa.converters.MoneyAttributeConverter.class)
    private com.tuxlogic.shiftiq.platform.shared.domain.model.valueobjects.Money subtotalAmount;
    ...
    @Convert(converter = com.tuxlogic.shiftiq.platform.shared.infrastructure.persistence.jpa.converters.MoneyAttributeConverter.class)
    private com.tuxlogic.shiftiq.platform.shared.domain.model.valueobjects.Money totalAmount;
